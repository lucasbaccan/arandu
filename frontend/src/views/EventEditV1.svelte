...
<div class="variant-bar">
  ...
  <a class="variant-link current" href="/eventos1/{id}" on:click|preventDefault={() => navigate(`/eventos1/${id}`)}>V1 · Status no topo</a>
            ...
            <p class="dash-user status-row">
              ...
              <span class="status-toggle">
                ...
                <span class="text-muted">
                  {status === 'OPEN_FOR_ANSWERS' ? 'Aceitando respostas' : 'Respostas fechadas'}
                </span>
              </span>
